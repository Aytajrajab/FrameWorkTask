...
{
    public partial class CreateRolesAndUsersAndCategoriesAndProductsAndFavoritesAndBasketsAndOrdersTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorite_User_userIdId",
                        column: x => x.userIdId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Product_productIdId",
                        column: x => x.productIdId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Order_User_userIdId",
                        column: x => x.userIdId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Basket_userIdId",
                table: "Basket",
                column: "userIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorite_userIdId",
                table: "Favorite",
                column: "userIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_productIdId",
                table: "Order",
                column: "productIdId");
